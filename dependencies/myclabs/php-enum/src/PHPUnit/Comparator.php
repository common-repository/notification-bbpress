...
namespace BracketSpace\Notification\bbPress\Dependencies\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \BracketSpace\Notification\bbPress\Dependencies\MyCLabs\Enum\PHPUnit\Comparator());
 */
