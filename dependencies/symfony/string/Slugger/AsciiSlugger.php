...
namespace BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\String\Slugger;

use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\String\AbstractUnicodeString;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\String\UnicodeString;
use Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
