...
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Cache\Exception\CacheException;
...
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
    ...
    protected function doSave(array $values, int $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\VarExporter\Internal\\', '', $value);
