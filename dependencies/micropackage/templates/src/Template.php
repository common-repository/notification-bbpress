...
namespace BracketSpace\Notification\bbPress\Dependencies\Micropackage\Templates;

use BracketSpace\Notification\bbPress\Dependencies\Micropackage\Templates\Exceptions\TemplateException;
use BracketSpace\Notification\bbPress\Dependencies\Micropackage\Templates\Exceptions\StorageException;
...
class Template {
	 ...
	 * Filesystem instance
	 *
	 * @var BracketSpace\Notification\bbPress\Dependencies\Micropackage\Filesystem\Filesystem
	 */
	private $fs;
