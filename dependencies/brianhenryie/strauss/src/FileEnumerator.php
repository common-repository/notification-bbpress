...
namespace BracketSpace\Notification\bbPress\Dependencies\BrianHenryIE\Strauss;
...
use BracketSpace\Notification\bbPress\Dependencies\BrianHenryIE\Strauss\Helpers\Path;
use BracketSpace\Notification\bbPress\Dependencies\League\Flysystem\Filesystem;
use BracketSpace\Notification\bbPress\Dependencies\League\Flysystem\Local\LocalFilesystemAdapter;
...
class FileEnumerator
{
    ...
    public function compileFileList(): DiscoveredFiles
    {
        foreach ($this->dependencies as $dependency) {
             ...
             *
             * [ "psr-4" => [ "BracketSpace\Notification\bbPress\Dependencies\BrianHenryIE\Strauss" => "src" ] ]
...
//                          $this->findFilesInDirectory()
    ...
    /**
     * @uses \BracketSpace\Notification\bbPress\Dependencies\BrianHenryIE\Strauss\DiscoveredFiles::add()
     *
     * @param ComposerPackage $dependency
     * @param string $packageRelativePath
     * @param string $autoloaderType
     * @throws \BracketSpace\Notification\bbPress\Dependencies\League\Flysystem\FilesystemException
     */
