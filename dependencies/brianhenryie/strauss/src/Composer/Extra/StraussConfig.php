...
namespace BracketSpace\Notification\bbPress\Dependencies\BrianHenryIE\Strauss\Composer\Extra;

use BracketSpace\Notification\bbPress\Dependencies\Composer\Composer;
use Exception;
use BracketSpace\Notification\bbPress\Dependencies\JsonMapper\JsonMapperFactory;
...
class StraussConfig
{
    ...
    public function __construct(Composer $composer)
    {
        ...
        if (!is_null($configExtraSettings)) {
            ...
            $mapper->push(new \BracketSpace\Notification\bbPress\Dependencies\JsonMapper\Middleware\CaseConversion(
                \BracketSpace\Notification\bbPress\Dependencies\JsonMapper\Enums\TextNotation::UNDERSCORE(),
                \BracketSpace\Notification\bbPress\Dependencies\JsonMapper\Enums\TextNotation::CAMEL_CASE()
            ));
        ...
        if (empty($this->packages)) {
            $this->packages = array_map(function (\BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Link $element) {
