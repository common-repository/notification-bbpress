...
namespace BracketSpace\Notification\bbPress\Dependencies\JsonSchema\Uri\Retrievers;
...
class Curl extends AbstractRetriever
{
     ...
     * {@inheritdoc}
     *
     * @see \BracketSpace\Notification\bbPress\Dependencies\JsonSchema\Uri\Retrievers\UriRetrieverInterface::retrieve()
     */
    public function retrieve($uri)
    {
        ...
        if (false === $response) {
            throw new \BracketSpace\Notification\bbPress\Dependencies\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
