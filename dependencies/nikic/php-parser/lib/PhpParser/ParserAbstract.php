...
namespace BracketSpace\Notification\bbPress\Dependencies\PhpParser;
...
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Expr\Array_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Expr\Cast\Double;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Identifier;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\InterpolatedStringPart;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Name;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Param;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Scalar\InterpolatedString;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Scalar\Int_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Scalar\String_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Class_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\ClassConst;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\ClassMethod;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Else_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\ElseIf_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Enum_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Interface_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Namespace_;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Nop;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\Property;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\Stmt\TryCatch;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\Node\UseItem;
use BracketSpace\Notification\bbPress\Dependencies\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
