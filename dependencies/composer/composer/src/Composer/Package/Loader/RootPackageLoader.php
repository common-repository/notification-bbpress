...
class RootPackageLoader extends ArrayLoader
{
     ...
     */
    public function load(array $config, string $class = 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootPackage', ?string $cwd = null): BasePackage
    {
        if ($class !== 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootPackage') {
