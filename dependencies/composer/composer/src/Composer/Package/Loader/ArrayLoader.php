...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Loader;
...
class ArrayLoader implements LoaderInterface
{
     ...
     * @inheritDoc
     */
    public function load(array $config, string $class = 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackage'): BasePackage
    {
        if ($class !== 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackage' && $class !== 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootPackage') {
    ...
    public function loadPackages(array $versions): array
    {
        ...
        foreach ($versions as $version) {
            $package = $this->createObject($version, 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackage');
