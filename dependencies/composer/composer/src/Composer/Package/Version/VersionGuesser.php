...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\HgDriver;
use BracketSpace\Notification\bbPress\Dependencies\Composer\IO\NullIO;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\VersionParser as SemverVersionParser;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Svn as SvnUtil;
use BracketSpace\Notification\bbPress\Dependencies\React\Promise\CancellablePromiseInterface;
                        ...
                        if (strlen($output) < $length) {
                            ...
                            if ($length === 0) {
                                foreach ($promises as $promise) {
                                    ...
                                    \BracketSpace\Notification\bbPress\Dependencies\React\Promise\resolve($promise)->cancel();
                                }
                            }
                        }
                    });
