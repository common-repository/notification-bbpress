...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload;

use BracketSpace\Notification\bbPress\Dependencies\Composer\ClassMapGenerator\ClassMap;
use BracketSpace\Notification\bbPress\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\Constraint\Bound;
...
EOF;
        ...
        $classMap->addClass('BracketSpace\Notification\bbPress\Dependencies\Composer\InstalledVersions', $vendorPath . '/composer/InstalledVersions.php');
        $classMap->sort();
...
class ComposerAutoloaderInit$suffix
{
    ...
    {
        if ('BracketSpace\\Notification\\bbPress\\Dependencies\\Composer\\Autoload\\ClassLoader' === \$class) {
            require __DIR__ . '/ClassLoader.php';
        }
    }

    /**
     * @return \BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\ClassLoader
     */
...
PLATFORM_CHECK;
        ...
        self::\$loader = \$loader = new \\BracketSpace\\Notification\\bbPress\\Dependencies\\Composer\\Autoload\\ClassLoader(\\dirname(__DIR__));
...
INCLUDE_PATH;
        ...
        call_user_func(\BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::getInitializer(\$loader));
...
REGISTER_LOADER;
        ...
        if ($useIncludeFiles) {
            $file .= <<<INCLUDE_FILES
        \$filesToLoad = \BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::\$files;
