...
use BracketSpace\Notification\bbPress\Dependencies\Composer\ClassMapGenerator\FileList;
...
class ClassMapGenerator
{
    ...
    {
        $generator = new \BracketSpace\Notification\bbPress\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator(['php', 'inc', 'hh']);
