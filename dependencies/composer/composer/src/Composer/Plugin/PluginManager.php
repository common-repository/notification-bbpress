...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin;

use BracketSpace\Notification\bbPress\Dependencies\Composer\Composer;
use BracketSpace\Notification\bbPress\Dependencies\Composer\EventDispatcher\EventSubscriberInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\InstallerInterface;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\Capability\Capability;
...
class PluginManager
{
    ...
    public function registerPackage(PackageInterface $package, bool $failOnMissingClasses = false, bool $isGlobalPlugin = false): void
    {
        ...
        foreach ($map['files'] as $fileIdentifier => $file) {
            ...
            \BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\composerRequire($fileIdentifier, $file);
        }
        ...
        foreach ($classes as $class) {
            ...
            if ($oldInstallerPlugin) {
                if (!is_a($class, 'BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\InstallerInterface', true)) {
                ...
                if (!is_a($class, 'BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\PluginInterface', true)) {
