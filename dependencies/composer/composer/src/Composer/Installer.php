...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer;

use BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\AutoloadGenerator;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Console\GithubActionError;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\DefaultPolicy;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\LocalRepoTransaction;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\LockTransaction;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Operation\UpdateOperation;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Operation\InstallOperation;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Operation\UninstallOperation;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\PoolOptimizer;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Pool;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Request;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Solver;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\SolverProblemsException;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\PolicyInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Downloader\DownloadManager;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Downloader\TransportException;
use BracketSpace\Notification\bbPress\Dependencies\Composer\EventDispatcher\EventDispatcher;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Filter\PlatformRequirementFilter\IgnoreListPlatformRequirementFilter;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterFactory;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\InstallationManager;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\InstallerEvents;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\SuggestedPackagesReporter;
use BracketSpace\Notification\bbPress\Dependencies\Composer\IO\IOInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\AliasPackage;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootAliasPackage;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\BasePackage;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackage;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackageInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Link;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Loader\ArrayLoader;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Dumper\ArrayDumper;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Version\VersionParser;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Package;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\ArrayRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\RepositorySet;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\CompositeRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\Constraint\Constraint;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Locker;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootPackageInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\InstalledArrayRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\InstalledRepositoryInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\InstalledRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\RootPackageRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\PlatformRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\RepositoryManager;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\LockArrayRepository;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Script\ScriptEvents;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\Constraint\ConstraintInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Advisory\Auditor;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Platform;
...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, bool $doInstall): int
    {
        ...
        } catch (\BracketSpace\Notification\bbPress\Dependencies\Seld\JsonLint\ParsingException $e) {
            if ($this->updateAllowList !== null || $this->updateMirrors) {
        ...
        \BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\CompilingMatcher::clear();
