...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer\EventDispatcher;

use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Transaction;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\InstallerEvent;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\PartialComposer;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\PreCommandRunEvent;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Platform;
use BracketSpace\Notification\bbPress\Dependencies\Composer\DependencyResolver\Operation\OperationInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\RepositoryInterface;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Script;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\PackageEvent;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Installer\BinaryInstaller;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\ProcessExecutor;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Script\Event as ScriptEvent;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Autoload\ClassLoader;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Console\Application;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Console\Command\Command;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Console\Input\StringInput;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Console\Output\ConsoleOutput;
use BracketSpace\Notification\bbPress\Dependencies\Symfony\Component\Process\PhpExecutableFinder;
        ...
        try {
            ...
            foreach ($listeners as $callable) {
                ...
                if (!is_string($callable)) {
                    ...
                    if (defined('BracketSpace\Notification\bbPress\Dependencies\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($event->getName())))) {
                    ...
                    $args = implode(' ', array_map(['BracketSpace\Notification\bbPress\Dependencies\Composer\Util\ProcessExecutor', 'escape'], $event->getArguments()));
