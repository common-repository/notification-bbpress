...
class Hg
{
    ...
    /**
     * @var \BracketSpace\Notification\bbPress\Dependencies\Composer\IO\IOInterface
     */
    private $io;

    /**
     * @var \BracketSpace\Notification\bbPress\Dependencies\Composer\Config
     */
    private $config;

    /**
     * @var \BracketSpace\Notification\bbPress\Dependencies\Composer\Util\ProcessExecutor
     */
    private $process;
