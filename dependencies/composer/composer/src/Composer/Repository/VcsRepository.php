...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\VcsDriverInterface;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Loader\ValidatingArrayLoader;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Loader\InvalidPackageException;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Loader\LoaderInterface;
...
class VcsRepository extends ArrayRepository implements ConfigurableRepositoryInterface
{
    ...
    public function __construct(array $repoConfig, IOInterface $io, Config $config, HttpDownloader $httpDownloader, ?EventDispatcher $dispatcher = null, ?ProcessExecutor $process = null, ?array $drivers = null, ?VersionCacheInterface $versionCache = null)
    {
        ...
        $this->drivers = $drivers ?: [
            'github' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\GitHubDriver',
            'gitlab' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\GitLabDriver',
            'bitbucket' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git-bitbucket' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\GitDriver',
            'hg' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\HgDriver',
            'perforce' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\PerforceDriver',
            'fossil' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\FossilDriver',
            // svn must be last because identifying a subversion server for sure is practically impossible
            'svn' => 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\Vcs\SvnDriver',
        ];
    ...
    /**
     * @return \BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompletePackage|\BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompleteAliasPackage|null|false null if no cache present, false if the absence of a version was cached
     */
