...
class RepositoryManager
{
     ...
     * @param string|\BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\Constraint\ConstraintInterface $constraint package version or version constraint to match against
     */
