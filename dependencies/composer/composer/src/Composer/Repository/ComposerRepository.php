...
namespace BracketSpace\Notification\bbPress\Dependencies\Composer\Repository;

use BracketSpace\Notification\bbPress\Dependencies\Composer\Advisory\PartialSecurityAdvisory;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Advisory\SecurityAdvisory;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\CompleteAliasPackage;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Version\VersionParser;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Version\StabilityFilter;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Json\JsonFile;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Cache;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\PostFileDownloadEvent;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\CompilingMatcher;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\HttpDownloader;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Loop;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\PluginEvents;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Plugin\PreFileDownloadEvent;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Semver\Constraint\MatchAllConstraint;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Http\Response;
use BracketSpace\Notification\bbPress\Dependencies\Composer\MetadataMinifier\MetadataMinifier;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Url;
use BracketSpace\Notification\bbPress\Dependencies\React\Promise\PromiseInterface;
...
class ComposerRepository extends ArrayRepository implements ConfigurableRepositoryInterface, AdvisoryProviderInterface
{
    ...
    private function asyncFetchFile(string $filename, string $cacheKey, ?string $lastModifiedTime = null): PromiseInterface
    {
        ...
        if (isset($this->packagesNotFoundCache[$filename])) {
            return \BracketSpace\Notification\bbPress\Dependencies\React\Promise\resolve(['packages' => []]);
        }
        ...
        if (isset($this->freshMetadataUrls[$filename]) && $lastModifiedTime) {
            ...
            $promise = \BracketSpace\Notification\bbPress\Dependencies\React\Promise\resolve(true);
