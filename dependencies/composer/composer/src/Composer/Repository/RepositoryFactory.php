...
class RepositoryFactory
{
    ...
    public static function manager(IOInterface $io, Config $config, ?HttpDownloader $httpDownloader = null, ?EventDispatcher $eventDispatcher = null, ?ProcessExecutor $process = null): RepositoryManager
    {
        ...
        $rm->setRepositoryClass('composer', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\ComposerRepository');
        $rm->setRepositoryClass('vcs', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('package', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\PackageRepository');
        $rm->setRepositoryClass('pear', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\PearRepository');
        $rm->setRepositoryClass('git', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('bitbucket', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('git-bitbucket', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('github', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('gitlab', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('svn', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('fossil', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('perforce', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('hg', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\VcsRepository');
        $rm->setRepositoryClass('artifact', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\ArtifactRepository');
        $rm->setRepositoryClass('path', 'BracketSpace\Notification\bbPress\Dependencies\Composer\Repository\PathRepository');
