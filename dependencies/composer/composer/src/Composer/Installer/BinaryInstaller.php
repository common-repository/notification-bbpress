...
if (PHP_VERSION_ID < 80000) {
    if (!class_exists('BracketSpace\Notification\bbPress\Dependencies\Composer\BinProxyWrapper')) {
        /**
         * @internal
         */
    ...
    if (
        ...
        || (function_exists('stream_wrapper_register') && stream_wrapper_register('phpvfscomposer', 'BracketSpace\Notification\bbPress\Dependencies\Composer\BinProxyWrapper'))
    ) {
