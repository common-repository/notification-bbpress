...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Archiver;
use BracketSpace\Notification\bbPress\Dependencies\Composer\Package\Version\VersionGuesser;
...
use BracketSpace\Notification\bbPress\Dependencies\Composer\EventDispatcher\Event;
use Phar;
...
class Factory
{
    ...
    public function createComposer(IOInterface $io, $localConfig = null, $disablePlugins = false, ?string $cwd = null, bool $fullLoad = true, bool $disableScripts = false)
    {
        ...
        if ($fullLoad) {
            ...
            if (false === $disablePlugins && false === $disableScripts && !class_exists('BracketSpace\Notification\bbPress\Dependencies\Composer\InstalledVersions', false) && file_exists($installedVersionsPath = $config->get('vendor-dir').'/composer/installed.php')) {
                ...
                if (class_exists('BracketSpace\Notification\bbPress\Dependencies\Composer\InstalledVersions')) {
        ...
        $package = $loader->load($localConfig, 'BracketSpace\Notification\bbPress\Dependencies\Composer\Package\RootPackage', $cwd);
