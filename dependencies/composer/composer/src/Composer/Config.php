...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Config\ConfigSourceInterface;
...
class Config
{
     ...
     * "scripts": {
     *   "watch": [
     *     "BracketSpace\\Notification\\bbPress\\Dependencies\\Composer\\Config::disableProcessTimeout",
