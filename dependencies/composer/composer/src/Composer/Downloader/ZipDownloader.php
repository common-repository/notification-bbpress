...
class ZipDownloader extends ArchiveDownloader
{
    ...
    private function extractWithSystemUnzip(PackageInterface $package, string $file, string $path): PromiseInterface
    {
        ...
        $io = $this->io;
        $tryFallback = function (\Throwable $processError) use ($isLastChance, $io, $file, $path, $package, $executable): \BracketSpace\Notification\bbPress\Dependencies\React\Promise\PromiseInterface {
            if ($isLastChance) {
                throw $processError;
            }
