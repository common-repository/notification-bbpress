...
use BracketSpace\Notification\bbPress\Dependencies\Composer\Downloader\FilesystemException;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        class_exists('BracketSpace\Notification\bbPress\Dependencies\Composer\Util\Platform');
        class_exists('BracketSpace\Notification\bbPress\Dependencies\Composer\Downloader\FilesystemException');
